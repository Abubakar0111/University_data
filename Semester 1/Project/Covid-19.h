...
using namespace std;
bool finished = false;
bool END_COVID(); //  F iib
void Covid()
{
    int Fever = 0, Cough = 0, LossOfTasteAndSmell = 0, Fatigue = 0, Headaches = 0, AchesAndPains = 0, Sneezing = 0, SoreThroat = 0, RunnyNose = 0, Diarrhoea = 0, ShortnessOfBreath = 0;
