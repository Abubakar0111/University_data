...
up:
    ...
    else if (FunQuestion(Question, "WHO"))
    {
        ...
        {
            Typing();
            cout << "AI-BOT : I WAS DESIGNED BY -- MUDASSAR \n ";
            goto up;
        }
        goto up;
    }
    ...
    else if (FunQuestion(Question, "DO"))
    {
    ...
    else if (FunQuestion(Question, "HAHA") || FunQuestion(Question, "HAHAHA"))
    {
        Typing();
    ...
    else if (FunQuestion(Question, "000"))
    {
        exit(0);
        // ennd = true;
        // EXIT();
